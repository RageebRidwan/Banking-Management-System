...
DATABASES = {
    "default": {
        ...
        "NAME": env("DB_NAME"),  # Reads DB_NAME from the .env file
        "USER": env("DB_USER"),  # Reads DB_USER from the .env file
        "PASSWORD": env("DB_PASSWORD"),  # Reads DB_PASSWORD from the .env file
